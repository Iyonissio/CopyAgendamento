...
<main>
	<div class="area_estabelecimento">
		<div class="area_informacao_esquerda">
			<h1>SALOES DISPONÍVEIS</h1>
			<p>Encontre uma variedade de Salões registados no sistema. Seleccione ou pesquise atravéz do nome do Restaurante pretendido e faça a sua reserva.</p>
		</div>
		<div class="pesquisar">
